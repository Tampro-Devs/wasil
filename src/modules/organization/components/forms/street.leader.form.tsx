...
interface StreetLeaderFormProps extends FormModalProps {
  leader?: Leader;
}
export default function StreetLeaderForm({
  isOpen,
  setIsOpen,
  leader,
}: StreetLeaderFormProps) {
      ...
      <AppFormProvider {...form}>
        ...
        >
          <LeadershipSelectInput
            category={LEADERSHIP_CATEGORY.STREET}
